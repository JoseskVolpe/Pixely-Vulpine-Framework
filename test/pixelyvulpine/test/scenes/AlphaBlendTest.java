...
public class AlphaBlendTest extends Layout{
	...
	public AlphaBlendTest(MIDlet app) {
		...
		Canvas colors = new Canvas(this, new DimensionAttributes(new DimensionAttributes.Scaled(0, 0, 100, 100), new DimensionAttributes.Offset(0, 0, 0, -l.getFont().getHeight()-7)));
